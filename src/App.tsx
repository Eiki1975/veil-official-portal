...
function GallerySection() {
  ...
  return <section className="section gallery-section" id="gallery"><SectionTitle eyebrow="INDEPENDENT OBSERVER / VISUAL FILE" title="OBSERVATION LOG" copy="音が止まったあとに残った、12の断片。" />
